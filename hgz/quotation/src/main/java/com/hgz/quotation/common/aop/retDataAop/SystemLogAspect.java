package com.hgz.quotation.common.aop.retDataAop;

import com.hgz.quotation.common.annotation.Result;
import com.hgz.quotation.utils.ResultDataUtils;
...
public class SystemLogAspect {
     ...
     */
    @Pointcut("execution(* com.hgz.quotation.module.*.controller.*.*(..))")
