            ...
            <table>
                <tr>
                    ...
                    <td>
                        <p>
                            <span>&nbsp;&nbsp;&nbsp;工&nbsp;&nbsp;&nbsp;号</span>
                            <el-input placeholder="请输入教师工号" v-model.trim="account.user"  :maxlength='20'></el-input>
                        </p>
                        <p>
                            <span>&nbsp;&nbsp;&nbsp;姓&nbsp;&nbsp;&nbsp;名</span>
                            <el-input placeholder="请输入教师姓名" v-model.trim="account.user"  :maxlength='20'></el-input>
                        </p>
                        <p>
                            <span>&nbsp;&nbsp;&nbsp;学&nbsp;&nbsp;&nbsp;院</span>
                        ...
                        <p>
                            <span>邮箱账号</span>
                            <el-input placeholder="请输入教师邮箱账号" v-model.trim="account.mail" >
                            </el-input>
                        </p>
                        <p>
                            <span>创建密码</span>
