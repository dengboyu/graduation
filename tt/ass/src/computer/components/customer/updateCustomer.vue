...
<template>
    <div class="tmpl editProduct">
        <span style="margin-left:290px;margin-bottom:10px;display:inline-block">更新客户信息</span>
        <el-form ref="form" :model="form" label-width="90px" :inline="true">
            <el-form-item label="公司名称" style="width:39.5%">
                <el-input v-model="form.comName" readonly></el-input>
            ...
            <el-form-item style='width:100%'>
                <el-button type="primary" @click="onSubmit" style="margin-top: 30px;margin-left: 280px;">更新</el-button>
    ...
    export default{
        ...
        methods:{
            onSubmit() {
                ...
                this.$http.axios({
                    url:'/customer/updateCustomerEntity',
                    method:'post',
                    data:this.form,
                    json:true,
                }).then(resolve=>{

                    this.$router.push({path:'/index/addCustomer'});
            ...
            getCustomerListById(id){
                ...
                this.$http.axios({
                    url:'/customer/getCustomerListById?id='+id,
                    method:'get',
                }).then(resolve=>{
        ...
        created(){
            this.getCustomerListById(this.$route.params.id);
        }
    }
</script>
