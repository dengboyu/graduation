...
public class MyRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
        ...
        userInfoEntity.setNick(token.getUsername());
        try {
        ...
        if(true){
            AuthenticationInfo authcInfo = new SimpleAuthenticationInfo(userInfoEntity.getNick(),userInfoEntity.getPassword(), this.getName());
